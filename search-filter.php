            ...
            <div class="row">
                <div class="col-md-12 mt-5">
                    <div class="card-header">
                        <h4 class="card-title">How to Filter/Search Record from Database in PHP MySqli</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_POST['filter_btn'])){
                                        ...
                                        $query = "SELECT * FROM employee WHERE CONCAT(name,phone,address) LIKE '%$value_filter%'";
